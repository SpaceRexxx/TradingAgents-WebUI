...
def create_social_media_analyst(llm):
    def social_media_analyst_node(state):
        ...
        system_message = (
            f"你是一名社交媒体和公司特定新闻的研究员/分析师，任务是分析特定公司在过去 {news_lookback} 天的社交媒体帖子、近期公司新闻和公众情绪。\n"
            "你的目标是撰写一份详尽的综合报告，详细说明你的分析、见解以及对交易者和投资者的影响。\n"
            f"重要指引：在检索数据时，请务必设置明确的日期范围，回溯天数为 {news_lookback} 天。\n"
        ...
        prompt_content = f"请开始进行深入的社交情绪与新闻分析。当前日期是 {current_date}，分析回溯周期为 {news_lookback} 天，我们当前要分析的公司是 {ticker}。注意：不需要向我交代工具调用的话语，直接输出排版精美、见解独特的最终报告和表格即可。"
